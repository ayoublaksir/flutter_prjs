...
class AdsService extends ChangeNotifier {
  ...
  bool shouldShowInterstitialForAction(String action) {
    ...
    switch (action) {
      ...
      case 'routine_creation':
        return _interstitialSwipeCount >= 1; // Show after creating first routine
      case 'routine_save':
        return _interstitialSwipeCount >= 2; // Show after customizing routine
  ...
  bool shouldShowInterstitialAd() {
    ...
    // NO TIME RESTRICTION - show immediately after required swipes
  ...
  Future<void> showInterstitialAd() async {
    ...
    try {
      ...
      // Timing is now handled by separate counters
